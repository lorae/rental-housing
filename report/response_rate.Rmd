...
In total, **11,338** BSAs were selected for participation in the 2015 RHFS.

**Table 4: 2018 RHFS Sample Size by Stratum**
![table04](docs/table04.png)
