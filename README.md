...
Methodology page: https://www.census.gov/programs-surveys/rhfs/technical-documentation/methodology.html
...
- *2021*: The target population for the survey is ["all rental housing in the United States, circa 2020."](https://www.census.gov/programs-surveys/rhfs/technical-documentation/methodology.2021.html#list-tab-2013961092). The data were constructed using the 2019 American Housing Survey (AHS). All rented units, owner occupied and listed as "for sale or rent", and vacant units for rent are considered part of the population. 11,510 cases were sampled, and 5,106 had complete interviews.
