...
Table X displays item response rates to selected survey questions, listed below.
...
**Table X: Item Response Rates (%) to Selected Questions in 2012, 2015, 2018, and 2021 Waves**
```{r tablex, echo = FALSE}
