...
<div id="sidebar">
    ...
    <ul>
        ...
        <li><a href="#responserates">Response Rates</a></li>
        <li><a href="#comparisons">Comparisons Over Time</a></li>
        <li><a href="#datause">Data Use and Access</a></li>
        <li><a href="#detail">Detailed Survey Methodology</a></li>
    </ul>
</div>
')
```
