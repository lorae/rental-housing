...
```{r flowchart, echo=FALSE, out.width='100%', out.height='100%'}
library(DiagrammeR)
...
digraph flowchart {
  ...
  refined_sample [label='Refined Sample\n3,467'];
  completed_interview [label='Completed Interviews\n2,264'];

  total_bsas -> sampled_bsas -> refined_sample -> completed_interview;
}
")
```
...
After this stage of refinement, **3,467** BSAs remained in the sample. [As far as I can intuit from the documentation, at this stage, each BSA is assumed to represent a separate property. However, I am not sure about that.]
